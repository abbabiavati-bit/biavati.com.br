...
export default function Aluguel() {
  ...
  return (
    <section aria-label="Aluguel" className="bg-[var(--brand-bg-page)] py-16 md:py-24 text-[var(--brand-fg)]">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center">
          <h1 className="text-3xl sm:text-4xl font-semibold" style={{ fontFamily: 'var(--brand-font)' as string }}>Aluguel</h1>
          <p className="mt-3" style={{ fontFamily: 'var(--brand-font-sans)' as string }}>Seleção sob medida para temporadas e long stays com conforto e praticidade.</p>
          <div className="mt-6">
            <a
              href={whats}
              target="_blank"
